  ...
  return (
    <section id="top" className="bg-white pb-16 pt-10 sm:pb-20 lg:pt-16">
      <div className="section-container grid items-center gap-10 lg:grid-cols-[1.02fr_0.98fr]">
        <div>
          <p className="inline-flex rounded-full bg-hyper-orange/10 px-4 py-2 text-sm font-semibold text-hyper-orange">
            HyperWork Gear
          </p>
          <h1 className="mt-5 max-w-3xl text-5xl font-semibold leading-tight tracking-normal text-hyper-text sm:text-6xl lg:text-7xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a
              href="#products"
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-hyper-orange px-6 text-base font-semibold text-white transition hover:-translate-y-0.5 hover:bg-hyper-orange-hover"
            >
              Xem sản phẩm
        ...
        <div className="relative">
          <div className="absolute -right-2 top-8 z-10 max-w-[250px] rounded-3xl border border-hyper-border bg-white p-4 shadow-soft">
            <div className="flex gap-3">
              ...
              <p className="text-sm font-semibold leading-5 text-hyper-text">
